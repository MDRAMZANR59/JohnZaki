...
<div class="container mt-5">
    ...
    <div class="card shadow-lg">
        ...
        <div class="card-body">
            <form action="{{ route('collar.update',$data->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <button collar="submit" class="btn btn-success btn-lg d-block mx-auto mt-4">Update</button>
            </form>
        </div>
    </div>
</div>
