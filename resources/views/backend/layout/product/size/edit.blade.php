            ...
            <form action="{{ route('size.update',$data->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="sizeName" placeholder="Enter Size Name" name="sizeName"
                        class="form-control" value="{{ $data->sizeName }}" />
                    @error('sizeName')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="chest" placeholder="Enter Size Name" name="chest"
                        class="form-control" value="{{ $data->chest }}" />
                    @error('chest')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" id="length" placeholder="Enter Size Name" name="length"
                        class="form-control" value="{{ $data->length }}" />
                    @error('length')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" id="sleeveLength" placeholder="Enter Size Name" name="sleeveLength"
                        class="form-control" value="{{ $data->sleeveLength }}" />
                    @error('sleeveLength')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
                </div>
