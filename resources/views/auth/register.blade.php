{{-- <x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" value="{{old('fname')}}" autofocus autocomplete="name" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" value="{{old('fname')}}" autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password" class="block mt-1 w-full"
                            type="password"
                            name="password"
                            value="{{old('fname')}}" autocomplete="new-password" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password_confirmation" class="block mt-1 w-full"
                            type="password"
                            name="password_confirmation" value="{{old('fname')}}" autocomplete="new-password" />
        ...
        <header class="bi-auth-header">
            <div class="container bi-logo-container">
                ...
                <div class="bi-redirect">
                    <a href="{{ route('home') }}" class="bi-back-to-website-button">Back To Website</a>
                </div>
            </div>
        </header>
        <!-- heading part end -->
            ...
            <div class="container bi-auth-form-container">
                <div class="bi-auth-form">
                    <div class="bi-auth-form-heading-section">
                        <h1 class="bi-auth-heading">Sign Up</h1>
                        <h3 class="bi-auth-subheading">
                            Sign Up to Buy or Sell Your Products!
                        </h3>
                    </div>
                    <form action="{{ route('register') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="bi-input-wrapper">
                            <input type="text" value="{{old('fname')}}" placeholder="First Name" id="fname" name="fname"/>
                            @error('fname')
                                <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
                        <div class="bi-input-wrapper">
                            <input value="{{old('lname')}}" type="text" placeholder="Last Name" id="lname" name="lname" />
                            @error('lname')
                            <p class="text-danger">{{$message}}</p>
                        @enderror
                        </div>
                        <div class="bi-input-wrapper">
                            <input value="{{old('phone')}}" type="text" placeholder="Phone Number" id="phone" name="phone" />
                            @error('phone')
                            <p class="text-danger">{{$message}}</p>
                        @enderror
                        </div>
                        ...
                        <div class="bi-input-wrapper">
                            <input type="password" placeholder="Confirm Password" id="cpassword" name="password_confirmation" />
